...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Deine Ordner</li>
        </ol>
        <h1>Deine Ordner</h1>
        <hr>
        <p>Hier sind deine Ordner aufgelistet. <br>Du kannst neue erstellen und diese umbennen. Sie geben dir auch einen Überblick über die Dateien. </p>
        <!-- Leeres DIV um der Seite größe zu geben-->
        <div align="right">
            <button type="button" name="create_folder" id="create_folder" class="btn btn-success">Ordner erstellen</button><br><br>
        ...
        $(document).on('click', '.remove_file', function(){
            ...
            if(confirm("Are you sure you want to remove this file?"))
            {
                $.ajax({
                    url:"../upload/uploaded/action.php",
                    method:"POST",
                    data:{path:path, action:action, file_id:file_id,},
                    success:function(data)
                    {
                        alert(data);
