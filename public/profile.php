...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <hr>
        <p>Hier kannst du dein Profilbild ändern. Viel Spaß dabei!</p>
        <div>
            <img src="../upload/uploaded/<?php echo "$owner_id" ?>/up/userpic.PNG" class="rounded-circle" alt="Nutzer" width="200" height="200">
        </div>
        <div>
            <?php
