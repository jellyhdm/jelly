    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="modal" data-target="#exampleModal" data-backdrop="static" data-keyboard="false">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                ?>
                    ...
                    <label>Ich habe einen Account <a href="index.php" data-toggle="modal" data-target="#exampleModal" >Einloggen</a></label>
                </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" name="txt_password" placeholder="Dein Passwort" required />
                    </div>
